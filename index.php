...
<body>
    <header>
        <nav class="navBar container">
            <div class="logo">
                <img src="./assets/img/Workwisr™.png" alt="">
            </div>
            <div class="button">
                <a href="./login.php">Login</a>
                <a href="">Start Your Job</a>
    ...
    <main>
        <div class="stars">
            <div class="star2"><img src="./assets/img/Star 3.png" alt=""></div>
            <div class="star1"><img src="./assets/img/Star 1.png" alt=""></div>
        </div>
        <section class="section container">
            <div class="left">
                <h2 class="title">1,000+ developers are choosing to workwisr</h2>
                <p>Whether you're an independent developer or a thriving agency, Workwisr is here to supercharge your
                    success.</p>
            </div>
        ...
        <section class="container first-section section d-flex justify-center-around">
            <div class="left-side">
                <img src="./assets/img/17_song_to_file_tr.png" alt="">
            </div>
            <div class="right-side">
                ...
                <div class="varified">
                    ...
                    <h3>Trust is the cornerstone of every fruitful collaboration. Our platform goes above and beyond to
                        cultivate trust by meticulously verifying and validating all clients.</h3>
                </div>
                <div class="varified">
                    <i class="fas fa-cubes"></i>
                    <span>Verified</span>
                    <h3>With our robust authentication processes, you can confidently engage with genuine clients who
                        value your expertise. Leave behind uncertainty and embrace a world where trust thrives.</h3>
                </div>
                <div class="varified">
                    <i class="fas fa-cube"></i>
                    <span>Verified Reviews and Stellar Ratings</span>
                    <h3>Leverage these testimonials to attract top-tier projects, and set yourself apart from the
                        competition. With Workwisr, your stellar track record will be your greatest asset.</h3>
                </div>
            </div>
        </section>
        <section class="container section d-flex justify-center-around">

            <div class="right-side">
                <h2>2.</h2>
                <h1>Always get paid</h1>
                <div class="varified">
                    <i class="far fa-bell"></i>
                    <span>Goodbye scams</span>
                    <h3>Once you complete milestones or project deliverables, funds are released promptly and securely.
                        No more chasing payments or dealing with unreliable clients—reclaim your focus on coding
                        brilliance while we handle the financial intricacies.</h3>
                </div>

            </div>
            <div class="left-side">
                <img src="./assets/img/16_poster_help_tr.png" alt="">
                <!-- <div class="star2"><img src="./assets/img/Star 3.png" alt=""></div> -->
            </div>
        </section>
        <section class="container section d-flex justify-center-around">
            <div class="left-side">
                <img src="./assets/img/8_golf_tr.png" alt="">
            </div>
            <div class="right-side">
                <div class="varified">
                    <i class="far fa-star"></i>
                    <span>Streamlined Project Management:</span>
                    <h3>Navigate through projects with ease using our intuitive interface, enabling you to track
                        progress, seamlessly communicate with clients, and securely share files. Say goodbye to chaos
                        and embrace the power of centralized project management tools, ensuring you consistently deliver
        ...
        <section class="container section group-sec d-flex justify-center align-items-center">
            <div>
                <h2>What are you waiting for?</h2>
                <div class="content d-flex justify-center-around">
                    <div class="left-side">
                        <img src="./assets/img/Group 1000002332.png" alt="">
                    </div>
                    <div class="right-side">
                        <div class="varified">
                            <span>“My life has been made 10 times easier!”</span>
                            <h3>Propel your freelance career or agency to new heights with a platform that elevates your
                                security, amplifies your efficiency, and fuels your professional growth. Trust.
                                Security. Success. Workwisr empowers you to conquer them all.</h3>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footer>
        <div class="footer-inner container d-flex justify-center-around align-items-center">
            <div class="info">
                <ul>
                    <li><img src="./assets/img/Workwisr™.png" alt=""></li>
                    <li><i class="fas fa-envelope"></i>help@workwisr.com</li>
                    <li><i class="fas fa-phone-alt"></i>US: +1 453 873 2393</li>
                    <li><i class="fas fa-phone-alt"></i>NL: +31 672 987 1092</li>
                </ul>
            </div>
            <div class="info">
                <ul>
        ...
        <p>Copyright 2023 Workwisr™.all rights reserved.</p>
    </footer>
